...
from kvae.compact_filter import CompactKalmanFilter
...
class CompactKalmanVariationalAutoencoder(object):
    ...
    def build_model(self):
        ...
        self.kf = CompactKalmanFilter(dim_z=self.config.dim_z,
    ...
    def build_loss(self):
        ...
        elbo_kf, kf_log_probs, z_smooth = self.kf.get_elbo(self.model_vars['smooth'],
                                                           ...
                                                           self.model_vars['C'])
        '''
        elbo_kf = self.kf.get_elbo(self.model_vars['filter'])
